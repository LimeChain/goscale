...
func (enc Encoder) Encode(o Option[int8]) {
	enc.EncodeBool(o.hasValue)
	if o.hasValue {
		enc.EncodeInt8(o.value)
	}
}

func (dec Decoder) Decode(o *Option[int8]) {
	o.hasValue = dec.DecodeBool()
	if o.hasValue {
		o.value = dec.DecodeInt8()
	}
}
