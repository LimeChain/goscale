...
func Test_EncodeTupleVaryingData(t *testing.T) {
	var testExamples = []struct {
	...
	}{
		{
			...
			input: TupleVaryingData{
				L0: NewVaryingData(U8(0), U8(42), Bool(true)),
				L1: NewVaryingData(U8(1), U128{math.MaxUint64, math.MaxUint64}, Empty{}),
			},
			expectation: []byte{
				0x0, 0x2a, 0x01, // L0
				0x1, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, // L1
			},
		},
	}
