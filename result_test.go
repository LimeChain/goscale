...
func Test_EncodeResult(t *testing.T) {
	var examples = []struct {
		...
		{label: "Encode Result(true, false)", input: Result[Encodable]{HasError: false, Value: Bool(false)}, expect: []byte{0x0, 0x0}},
		{label: "Encode Result(true, true)", input: Result[Encodable]{HasError: false, Value: Bool(true)}, expect: []byte{0x0, 0x1}},
		{label: "Encode Result(false, empty)", input: Result[Encodable]{HasError: true, Value: Empty{}}, expect: []byte{0x1}},
		{label: "Encode Result(false, true)", input: Result[Encodable]{HasError: true, Value: Bool(true)}, expect: []byte{0x1, 0x1}},

		{label: "Encode Result(true, U8(max))", input: Result[Encodable]{HasError: false, Value: U8(math.MaxUint8)}, expect: []byte{0x0, 0xff}},
		{label: "Encode Result(true, I8(min))", input: Result[Encodable]{HasError: false, Value: I8(math.MinInt8)}, expect: []byte{0x0, 0x80}},
		{label: "Encode Result(true, I8(max))", input: Result[Encodable]{HasError: false, Value: I8(math.MaxInt8)}, expect: []byte{0x0, 0x7f}},
		{label: "Encode Result(true, U16(max))", input: Result[Encodable]{HasError: false, Value: U16(math.MaxUint16)}, expect: []byte{0x0, 0xff, 0xff}},
		{label: "Encode Result(true, I16(min))", input: Result[Encodable]{HasError: false, Value: I16(math.MinInt16)}, expect: []byte{0x0, 0x00, 0x80}},
		{label: "Encode Result(true, U32(max))", input: Result[Encodable]{HasError: false, Value: U32(math.MaxUint32)}, expect: []byte{0x0, 0xff, 0xff, 0xff, 0xff}},
		{label: "Encode Result(true, I32(min))", input: Result[Encodable]{HasError: false, Value: I32(math.MinInt32)}, expect: []byte{0x0, 0x0, 0x0, 0x0, 0x80}},
		{label: "Encode Result(true, U64(max))", input: Result[Encodable]{HasError: false, Value: U64(math.MaxUint64)}, expect: []byte{0x0, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff}},
		{label: "Encode Result(true, I64(min))", input: Result[Encodable]{HasError: false, Value: I64(math.MinInt64)}, expect: []byte{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x80}},
		{label: "Encode Result(false, I64(min))", input: Result[Encodable]{HasError: true, Value: I64(math.MinInt64)}, expect: []byte{0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x80}},
		{label: "Encode Result(true, U128(max))", input: Result[Encodable]{HasError: false, Value: U128{math.MaxUint64, math.MaxUint64}}, expect: []byte{0x0, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff}},
		{label: "Encode Result(false, I128(min)", input: Result[Encodable]{HasError: true, Value: I128{U64(0), U64(math.MaxInt64 + 1)}}, expect: []byte{0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x80}},
		{label: "Encode Result(true, Compact(MaxUint64)", input: Result[Encodable]{HasError: false, Value: ToCompact(math.MaxUint64)}, expect: []byte{0x0, 0x13, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff}},

		{label: "Encode Result(true, empty Seq[U8])", input: Result[Encodable]{HasError: false, Value: Sequence[U8]{}}, expect: []byte{0x0, 0x0}},
		{label: "Encode Result(true, Seq[U8])", input: Result[Encodable]{HasError: false, Value: Sequence[U8]{42}}, expect: []byte{0x0, 0x4, 0x2a}},
		{label: "Encode Result(true, Result(false, Seq[U8])", input: Result[Encodable]{HasError: false, Value: Result[Encodable]{HasError: true, Value: Sequence[U8]{42, 43}}}, expect: []byte{0x0, 0x1, 0x8, 0x2a, 0x2b}},
	}
...
func Test_DecodeResultCompact(t *testing.T) {
	var examples = []struct {
	...
	}{
		{
			...
			expect:        Result[Compact]{false, ToCompact(math.MaxUint64)},
			bufferLenLeft: 0,
		},
	}
