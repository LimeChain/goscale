...
func Test_EncodeResult(t *testing.T) {
	var examples = []struct {
		...
		{label: "Encode Result(false, U128(max))", input: Result[Encodable]{true, U128{math.MaxUint64, math.MaxUint64}}, expect: []byte{0x1, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff}},
