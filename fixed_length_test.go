...
func Test_EncodeU128(t *testing.T) {
	var examples = []struct {
		...
		{label: "Encode U128 - (0x2a)", input: "42", expect: []byte{0x2a, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0}},
	}
...
func Test_DecodeU128(t *testing.T) {
	var examples = []struct {
		...
		{label: "Decode U128 - (0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF)", input: []byte{0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff}, expect: U128{math.MaxUint64, math.MaxUint64}, stringValue: "340282366920938463463374607431768211455"},
