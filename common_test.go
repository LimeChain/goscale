...
func Test_ToCompact(t *testing.T) {
	var examples = []struct {
		...
		{label: "ToCompact(int8)", input: int8(3), expect: Compact[Numeric]{NewI8(3)}},
		{label: "ToCompact(I8)", input: I8(4), expect: Compact[Numeric]{NewI8(4)}},
		...
		{label: "ToCompact(int16)", input: int16(7), expect: Compact[Numeric]{NewI16(7)}},
		{label: "ToCompact(I16)", input: I16(8), expect: Compact[Numeric]{NewI16(8)}},
		...
		{label: "ToCompact(int32)", input: int32(11), expect: Compact[Numeric]{NewI32(11)}},
		{label: "ToCompact(I32)", input: I32(12), expect: Compact[Numeric]{NewI32(12)}},
		...
		{label: "ToCompact(int64)", input: int64(15), expect: Compact[Numeric]{NewI64(15)}},
		{label: "ToCompact(I64)", input: I64(16), expect: Compact[Numeric]{NewI64(16)}},
		...
		{label: "ToCompact(I128)", input: NewI128(19), expect: Compact[Numeric]{NewI128(19)}},
